...
public class JsonMapper implements ObjectMapping {
    ...
    public <R> R read(String data, Class<R> clazz) {
        try {
            ...
            throw new JsonObjectProcessingCannotSetTypeException(e.getMessage(), CANNOT_DESERIALIZE_TO_GIVEN_CLASS);
        }
    }
    ...
    public <R> String write(R object, Class<R> clazz) {
        try {
            ...
            e.printStackTrace();
            throw new JsonObjectProcessingCannotSetTypeException(e.getMessage(), CANNOT_SERIALIZE_TO_JSON);
        }
    }
}