...
public interface JsonRepository<ID extends Serializable> {
    <R extends TableAnnotatedRecord<ID>> R findById(ID id, Class<R> clazz) throws EngineCodeException;
    <R extends TableAnnotatedRecord<ID>> List<R> findAll(Class<R> clazz) throws EngineCodeException;
    <R extends TableAnnotatedRecord<ID>> void save(R object, Class<R> clazz) throws EngineCodeException;
